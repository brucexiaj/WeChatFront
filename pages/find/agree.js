...
let audit = function(that){
	wx.request({
      ...
      data: {id:that.data.item.id,status:1,buyerId:app.globalData.buyerId,skuId:that.data.skuIdArr,skuCode:that.data.skuCodeArr,skuUpc:that.data.skuUpcArr, skuAmount:that.data.skuAmountArr, skuLimit:that.data.skuLimitArr},
      success: function (res) {
